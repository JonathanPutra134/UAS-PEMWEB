...
<body>
	...
	<div class="container">
		<div class="d-grid d-md-flex justify-content-md-end">
			<a href="<?php echo base_url("index.php/Admin/AddFacilitiesPage");?>" class="btn btn-primary mb-2"><i class="bi bi-plus-lg"></i> Add</a>
		</div>
    	...
    	<?php
				...
				foreach($facilities as $data) {
				    ...
				    echo "<td><img src=".base_url($data['Image'])." height='200px' width='200px' alt='image'></td>";
						...
						//BUTTON DELETE & EDIT
						echo "<td>";
							echo "<a href='" . base_url("index.php/Admin/EditFacilities?id=$id") . "' class='btn btn-primary me-1	'>Edit</a>";
